...
<body>
    ...
    if(strlen($limpaCpf) < 11) {
        ...
        echo "3- <span style='color:red;'> ERRO! </span> CPF inválido <br>";
        array_unshift($erro, 1);
    }
    if(strstr($email, '@') == false) {
        // strstr ==> Acha a primeira ocorrência de uma string. Senão encontrar retorna falso.
        echo "4- <span style='color:red;'> ERRO! </span> Formato de email inválido<br>";
        array_unshift($erro, 1);
    }
    ...
    if(empty($formacao)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "10- <span style='color:red;'> ERRO! </span> Preencher Formação<br>";
        array_unshift($erro, 1);
    }
    if(empty($cursou)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "11-<span style='color:red;'> ERRO! </span> Preencher a Instituição que se formou<br>";
        array_unshift($erro, 1);
    }
    if(empty($logradouro)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "12- <span style='color:red;'> ERRO! </span> Informe o endereço<br>";
        array_unshift($erro, 1);
    }
    if(empty($numero)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "13- <span style='color:red;'> ERRO! </span> Informe o número do endereço<br>";
        array_unshift($erro, 1);
    }
    if(empty($bairro)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "14- <span style='color:red;'> ERRO! </span> Informa o bairro<br>";
        array_unshift($erro, 1);
    }
    if(empty($cidade)) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "15- <span style='color:red;'> ERRO! </span> Informe a cidade<br>";
        array_unshift($erro, 1);
    }
    if(strlen($estado) != 2) {
        //  empty ==> Verifica se determinada string está vazia(nula).
        echo "16- <span style='color:red;'> ERRO!</span> O estado deve possuir 2 letras";
        array_unshift($erro, 1);
    }if(count($erro) == 0){
        ...
        echo "<span style='font-weight:bold;'>Nascimeto: </span>", $formataNascimento, "<br>";
        ...
        echo "<span style='font-weight:bold;'>Formação: </span>", $formacao, "<br>";
        echo "<span style='font-weight:bold;'>Curso de formação: </span>", $cursou, "<br>";
